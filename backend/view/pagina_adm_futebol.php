...
<div class="buttons">
        ...
        <a href="../controllers/pdf_futebol.php"><button>Baixar PDF</button></a>
    ...
    switch(@$_REQUEST["page"]){
        case "novo":
          include  __DIR__ . "../../view/tables/tabela_futebol.php";
        break;
        case "buscar":
            include  __DIR__ . "../../controllers/BuscarPessoaFutebol.php";

            ?>
            <form action="../controllers/BuscarPessoaFutebol.php" method="get">
